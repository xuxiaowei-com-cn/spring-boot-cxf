package cn.com.xuxiaowei.http12;

import cn.com.xuxiaowei.http12.bo.GetByIdRequestEnvelope;
import cn.com.xuxiaowei.http12.vo.GetByIdResponseEnvelope;
...
class HttpTests {
    ...
    void getById() throws JsonProcessingException {
        ...
        ResponseEntity<GetByIdResponseEnvelope> responseEntity = restTemplate.postForEntity("http://127.0.0.1:8080/ws/userService",
    ...
    void getByIdResponseString() throws JsonProcessingException {
        ...
        ResponseEntity<String> responseEntity = restTemplate.postForEntity("http://127.0.0.1:8080/ws/userService",
